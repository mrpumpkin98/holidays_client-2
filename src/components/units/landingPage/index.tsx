    ...
    <S.Wrapper>
      ...
      <S.Section2>
        <S.Article2>
          ...
          <S.Sentence2>
            오늘날 비건은 먹을거리 뿐만 아니라 ‘생활 전반에서 동물성 제품을
            사용하지 않는 철학이자 삶의 방식을 실천하는 사람’이라는 조금 더 넓은
            개념으로 이해하기 시작했습니다. 동시에 비거니즘의 정의가 넓어지면서
            소비자의 유형도 다양해졌습니다.
            <br />
            이러한 변화에 맞게 비거니즘을 실천하는 국내 소비자들을 위한 비거니즘
            전용 E-Commerce 서비스를 기획했습니다.
          </S.Sentence2>
        </S.Article2>
        <S.Arrows>
          <S.Path1 d="M0 0 L30 32 L60 0"></S.Path1>
      ...
      <S.Section3>
        <S.Article>
          <S.Title02>
            일상에서 쉽게 비거니즘을 실천할 수 있도록 네모비로 편리하게
          </S.Title02>
          <S.Sentence></S.Sentence>
          <Link href="/classPage">
            <S.Btn>홀리데이즈 상품 보러가기</S.Btn>
          </Link>
        </S.Article>
      </S.Section3>
    </S.Wrapper>
